...
export const PRESIDENT_POSITION_CODE = 'president';

// ประเภทชมรมที่ใช้ส่วนขยายกีฬาได้ (ยืนยันแล้วในระยะที่ 5) — ใช้ code เพื่อหาแถวข้อมูลหลัก ไม่ได้ใช้ตรวจสิทธิ์
export const SPORTS_CATEGORY_CODE = 'health_sports';
