...
**ขั้น 4.2 รายงาน** (ยังไม่เริ่ม)
- รายงานรายเดือน: ดึงกิจกรรมของเดือนอัตโนมัติ + บันทึกการประชุม, ประธาน/เลขาฯ (`club_report:submit`) ส่ง → ที่ปรึกษาบุคลากร (`club_report:acknowledge`) รับทราบ
- รายงานประจำปี: สรุปทั้งปีงบประมาณ ส่งสโมสร เจ้าหน้าที่รับทราบ; หน้าภาพรวมชมรมที่ค้างส่งรายงาน (แสดงผลเท่านั้น)
