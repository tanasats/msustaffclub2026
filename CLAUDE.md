...
## 1. ภาพรวมโปรเจกต์
- **ชื่อระบบ:** ระบบจัดการชมรมกีฬาบุคลากร มหาวิทยาลัยมหาสารคาม
- **วัตถุประสงค์:** เป็นระบบบริหารจัดการชมรมกีฬา ตั้งแต่ขั้นตอนการยื่นขอจัดตั้งชมรม การบริหารจัดการข้อมูลสถิตินักกีฬา สถิติการแข่งขัน ไปจนถึงการใช้ข้อมูลในระบบเพื่อคัดเลือกนักกีฬาตัวแทน ไปร่วมแข่งขันภายนอก หรือการใช้ข้อมูลเพื่อคัดเลือกนักกีฬารับรางวัลเชิดชูเกียรติได้
